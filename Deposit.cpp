 ...
 // performs transaction; overrides Transaction's pure virtual function void Deposit::execute()
 {
 ...
 if ( envelopeReceived )
 {
 screen.displayMessageLine( "Your envelope has been received." "NOTE: The money just will not be available until we"
